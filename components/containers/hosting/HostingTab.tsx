...
import one from "@/public/img/hosting/feature-circle.png";
...
import five from "@/public/img/hosting/feature-hosting.jpg";
import six from "@/public/img/hosting/feature-hosting-2.jpg";
      ...
      <div className="container">
        <div className="feature-content-warpper style-3">
          <div className="row g-4 justify-content-between align-items-center">
              ...
              <div className="hosting-image-2">
                ...
                <div className="row g-4">
                  ...
                  <div
                    ...
                    data-aos-delay="500"
                  >
                    <div className="hosting-thumb style-image">
            ...
            <div className="col-lg-6">
              <div className="feature-hosting-content ps-lg-4">
